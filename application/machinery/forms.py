...
class MultipleImagesField(forms.FileField):
    def __init__(self, *args, **kwargs):
        kwargs.setdefault("widget", ClearableFileInput(attrs={'multiple': True}))
...
class AltaMaquinariaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ubicacion', 'tipo_cancelacion', 'politica_cancelacion', 
    ...
    def clean_imagenes(self):
        ...
        for imagen in imagenes:
            ...
            if imagen.size > 5 * 1024 * 1024:  # 5MB
                raise ValidationError("El tamaño de cada imagen no debe exceder 5MB.")
